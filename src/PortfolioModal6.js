      ...
      <div className="container">
        <div className="row justify-content-center">
          <div className="col-lg-8">
            ...
            <img className="img-fluid rounded mb-5" src="dist/assets/img/portfolio/submarine.png" alt="..."/>
            ...
            <button className="btn btn-primary" data-bs-dismiss="modal"><i className="fas fa-xmark fa-fw"></i>Close Window</button>
          </div>
        </div>
      </div>
    </div>
